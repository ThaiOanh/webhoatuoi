...
<div>
    ...
    <div id="slides" class="carousel slide" data-ride="carousel">
          ...
          <div class="carousel-inner">
            <div class="carousel-item active">
              <img class="intro-slide" src="./assets/image/banner/1.jpg" alt="banner">
              <div class="carousel-caption d-none d-md-block" style="text-shadow: 2px 2px 2px #000;">
                <p class="font-italic font-weight-bold">"Hương thơm của hoa chỉ lan theo hướng gió. Nhưng lòng tốt của một người lan tỏa theo mọi hướng!"</p>
              </div>
            </div>
            <div class="carousel-item">
              <img class="intro-slide" src="./assets/image/banner/2.jpg" alt="banner">
              <div class="carousel-caption d-none d-md-block" style="text-shadow: 2px 2px 2px #000;">
                <p class="font-italic font-weight-bold">"Cuộc sống là một bông hoa và tình yêu là mật ong!"</p>
              </div>
            </div>
            <div class="carousel-item">
              <img class="intro-slide" src="./assets/image/banner/3.jpg" alt="banner">
              <div class="carousel-caption d-none d-md-block" style="text-shadow: 2px 2px 2px #000;">
                <p class="font-italic font-weight-bold">"Đủ nắng hoa sẽ nở, đủ gió mây sẽ bay và đủ yêu thương hạnh phúc sẽ đong đầy!"</p>
              </div>
            </div>
          </div>
        </div>
    ...
    <div class="container text-center">
        <h2 class="text-dark">Nguồn cung hoa tươi</h2>
        <p class="text-dark">
            <i
                >Chúng tôi cam kết mang đến cho quý khách hàng những bông hoa đẹp nhất và tươi nhất</i
            >
        </p>
    </div>
