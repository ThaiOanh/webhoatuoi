    ...
    <table class="table table-striped table-checkall">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <a target="" href="modules/manage_orders/delete-donhangdahuy.php?id=<?php echo $row_Order['ID_DonHang']?>" class="btn btn-danger btn-sm text-white"><i class="fa fa-trash"></i></a>
                </td>
            </tr>
        <?php
        }
